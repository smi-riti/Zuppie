  ...
  <div class="hidden md:flex md:flex-shrink-0">
    <div class="flex flex-col w-64 bg-gradient-to-br from-purple-50 via-pink-50 to-pink-100 border-r border-pink-200 shadow-lg">
      ...
      <nav class="flex-1 px-3 py-6 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('gallery.manage') }}" wire:navigate class="flex items-center px-4 py-3 text-base font-semibold rounded-xl group transition-all duration-300 text-purple-600 hover:bg-gradient-to-r hover:from-purple-100 hover:to-pink-100 hover:text-pink-700 hover:shadow-md hover:shadow-pink-200/30">
          <svg class="w-6 h-6 mr-3 text-purple-400 group-hover:text-pink-500 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
          </svg>
          Gallery
    ...
    <div class="flex flex-col h-full">
      ...
      <nav class="flex-1 px-3 py-6 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('admin.reviews.show') }}" wire:navigate class="flex items-center px-4 py-3 text-base font-semibold rounded-xl group transition-all duration-300 text-purple-600 hover:bg-gradient-to-r hover:from-purple-100 hover:to-pink-100 hover:text-pink-700 hover:shadow-md hover:shadow-pink-200/30">
          <svg class="w-6 h-6 mr-3 text-purple-400 group-hover:text-pink-500 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
          </svg><a href="{{ route('gallery.manage') }}" wire:navigate class="flex items-center px-4 py-3 text-base font-semibold rounded-xl group transition-all duration-300 text-purple-600 hover:bg-gradient-to-r hover:from-purple-100 hover:to-pink-100 hover:text-pink-700 hover:shadow-md hover:shadow-pink-200/30">
          <svg class="w-6 h-6 mr-3 text-purple-400 group-hover:text-pink-500 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
          </svg>
          Gallery
        ...
        <a href="/admin/settings" wire:navigate class="flex items-center px-4 py-3 text-base font-semibold rounded-xl group transition-all duration-300 text-purple-600 hover:bg-gradient-to-r hover:from-purple-100 hover:to-pink-100 hover:text-pink-700 hover:shadow-md hover:shadow-pink-200/30">
        <a href="{{ route('admin.settings') }}" wire:navigate class="flex items-center px-4 py-3 text-base font-semibold rounded-xl group transition-all duration-300 text-purple-600 hover:bg-gradient-to-r hover:from-purple-100 hover:to-pink-100 hover:text-pink-700 hover:shadow-md hover:shadow-pink-200/30">
          <svg class="w-6 h-6 mr-3 text-purple-400 group-hover:text-pink-500 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
