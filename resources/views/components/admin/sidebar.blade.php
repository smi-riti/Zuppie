  ...
  <div class="hidden md:flex md:flex-shrink-0">
    <div class="flex flex-col w-64 border-r border-gray-200 bg-gradient-to-br from-purple-100 via-pink-100 to-pink-50">
      ...
      <nav class="flex-1 px-2 py-4 space-y-2">
        ...
        <a href="{{ route('admin.offers.show') }}" wire:navigate class="flex items-center px-3 py-2 text-sm font-medium rounded-md group transition-all duration-200 text-gray-700 hover:bg-white hover:text-pink-700 hover:shadow-sm">
