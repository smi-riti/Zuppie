                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" wire:model="form.title" id="title"
                                class="w-full px-4 py-2 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200 focus:border-purple-300">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea wire:model="form.content" id="content" rows="6"
                                class="w-full px-4 py-2 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200 focus:border-purple-300"></textarea>
                            ...
                            <div class="flex items-center">
                                @if ($image)
                                    <img src="{{ is_string($image) ? $image : $image->temporaryUrl() }}" 
                                        alt="Preview" class="h-32 w-32 object-cover rounded-lg mr-4 border border-purple-200">
                                @endif
                                <input type="file" wire:model="image" id="image" class="hidden">
                                <label for="image" class="cursor-pointer bg-purple-100 hover:bg-purple-200 text-purple-700 px-4 py-2 rounded-lg transition">
                        ...
                        <div>
                            <label class="inline-flex items-center mt-6">
                                <input type="checkbox" wire:model="form.is_published" class="rounded border-purple-300 text-pink-600 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50">
