        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="mb-2"><span class="font-medium">Start:</span> {{ $booking->event_date?->format('M d, Y h:i A') }}</div>
                    <div class="mb-2"><span class="font-medium">End:</span> {{ $booking->event_end_date?->format('M d, Y h:i A') }}</div>
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="mb-2"><span class="font-medium">Payment Method:</span> {{ $booking->payment_method }}</div>
                </div>
                <div>
            ...
            <div class="flex justify-end pt-4">
                <button type="button" onclick="window.history.back()" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg shadow hover:bg-gray-300">Close</button>
            </div>
        </div>
    </div>
</div>
