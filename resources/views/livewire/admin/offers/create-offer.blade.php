                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="flex flex-col items-center justify-center w-full px-4 py-6 border-2 border-dashed border-pink-200 rounded-lg cursor-pointer bg-pink-50 hover:bg-pink-100 transition">
                                ...
                                <span class="mt-2 text-sm text-purple-700">Click to upload image</span>
                                <input type="file" wire:model.live="image" class="hidden">
                            </label>
                            @if($image)
                                <div class="relative">
                                    <img src="{{ $image->temporaryUrl() }}" class="h-24 w-24 object-cover rounded-lg border-2 border-pink-200 shadow-sm">
                                    <button type="button" wire:click="$set('image', null)" class="absolute -top-2 -right-2 bg-pink-500 text-white rounded-full p-1 hover:bg-pink-600 transition">
