    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition">
            <div class="flex justify-between items-center border-b border-purple-100 pb-4 mb-6">
                ...
                <button class="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:opacity-90 transition shadow-md hover:shadow-lg">
                    View All
                </button>
            </div>
            ...
            <div class="space-y-4">
                <!-- Event 1 -->
                <div class="flex items-center py-3 border-b border-purple-100 hover:bg-purple-50 transition rounded-lg px-2">
                    <div class="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold mr-4">
                        BS
                    </div>
                    <div class="flex-grow">
                        <div class="font-semibold text-purple-800">Baby Shower - Emma Wilson</div>
                        <div class="text-xs text-purple-500">June 15, 2023 • 2:00 PM • 25 Guests</div>
                    </div>
                    <div class="flex space-x-2">
                        <button class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 hover:bg-purple-200 transition">✏️</button>
                        <button class="w-8 h-8 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 hover:bg-pink-200 transition">🗑️</button>
                    </div>
                </div>
                ...
                <div class="flex items-center py-3 border-b border-purple-100 hover:bg-purple-50 transition rounded-lg px-2">
                    ...
                    <div class="flex-grow">
                        <div class="font-semibold text-purple-800">Birthday - Michael Brown</div>
                        <div class="text-xs text-purple-500">June 18, 2023 • 4:00 PM • 30 Guests</div>
                    </div>
                    <div class="flex space-x-2">
                        <button class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 hover:bg-purple-200 transition">✏️</button>
                        <button class="w-8 h-8 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 hover:bg-pink-200 transition">🗑️</button>
                ...
                <div class="flex items-center py-3 border-b border-purple-100 hover:bg-purple-50 transition rounded-lg px-2">
                    ...
                    <div class="flex-grow">
                        <div class="font-semibold text-purple-800">Birthday - Sophia Martinez</div>
                        <div class="text-xs text-purple-500">June 20, 2023 • 1:00 PM • 15 Guests</div>
                    </div>
                    <div class="flex space-x-2">
                        <button class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 hover:bg-purple-200 transition">✏️</button>
                        <button class="w-8 h-8 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 hover:bg-pink-200 transition">🗑️</button>
                ...
                <!-- Event 4 -->
                <div class="flex items-center py-3 hover:bg-purple-50 transition rounded-lg px-2">
                    <div class="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold mr-4">
                        BS
                    </div>
                    <div class="flex-grow">
                        <div class="font-semibold text-purple-800">Baby Shower - Olivia Johnson</div>
                        <div class="text-xs text-purple-500">June 22, 2023 • 3:00 PM • 20 Guests</div>
                    </div>
                    <div class="flex space-x-2">
                        <button class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 hover:bg-purple-200 transition">✏️</button>
                        <button class="w-8 h-8 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 hover:bg-pink-200 transition">🗑️</button>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <div class="flex space-x-2">
                        <button class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 hover:bg-purple-200 transition">←</button>
                        <button class="w-8 h-8 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 hover:bg-purple-200 transition">→</button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-7 gap-1 text-center">
                    ...
                    <div class="py-1 text-sm bg-pink-500 text-white rounded-md font-medium cursor-pointer hover:bg-pink-600 transition">15</div>
                    <div class="py-1 text-sm text-purple-700">16</div>
                    <div class="py-1 text-sm text-purple-700">17</div>

                    <div class="py-1 text-sm bg-pink-500 text-white rounded-md font-medium cursor-pointer hover:bg-pink-600 transition">18</div>
                    <div class="py-1 text-sm text-purple-700">19</div>
                    <div class="py-1 text-sm bg-pink-500 text-white rounded-md font-medium cursor-pointer hover:bg-pink-600 transition">20</div>
                    <div class="py-1 text-sm text-purple-700">21</div>
                    <div class="py-1 text-sm bg-pink-500 text-white rounded-md font-medium cursor-pointer hover:bg-pink-600 transition">22</div>
                    <div class="py-1 text-sm text-purple-700">23</div>
                    <div class="py-1 text-sm text-purple-700">24</div>

                    <div class="py-1 text-sm border-2 border-purple-500 rounded-md font-medium cursor-pointer hover:bg-purple-50 transition">25</div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button class="bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 px-3 rounded-md text-sm font-medium hover:opacity-90 transition shadow-md hover:shadow-lg">
                        + New Event
                    </button>
                    <button class="bg-white border border-purple-200 text-purple-700 py-2 px-3 rounded-md text-sm font-medium hover:bg-purple-50 transition">
                        Add Client
                    </button>
                    <button class="bg-white border border-purple-200 text-purple-700 py-2 px-3 rounded-md text-sm font-medium hover:bg-purple-50 transition">
                        Inventory Check
