                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <!-- Upload Progress -->
                            <div wire:loading wire:target="image" wire:key="image-loading" class="mt-3 flex items-center text-pink-600">
                                <svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-pink-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
