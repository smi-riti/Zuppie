<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" x-data="{ show: true }" x-show="show" wire:ignore.self>
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <h3 class="text-lg font-medium mb-4">Create Package</h3>
        ...
        <form wire:submit.prevent="submit">
            ...
            <div class="flex justify-end">
                <button type="button" wire:click="$dispatch('closeCreateModal')" class="mr-2 px-4 py-2 bg-gray-300 rounded">Cancel</button>
