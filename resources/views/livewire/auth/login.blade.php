        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input wire:model="remember" id="remember" name="remember" type="checkbox"
                                class="h-4 w-4 text-zuppie-pink-600 focus:ring-zuppie-pink-500 border-gray-300 rounded">
                            <label for="remember" class="ml-2 block text-sm text-gray-700">Remember me</label>
                        </div>
                        <div class="text-sm">
                            <a href="{{ route('password.request') }}"
                                class="font-medium text-zuppie-pink-600 hover:text-zuppie-pink-500">Forgot password?</a>
                        </div>
                    </div>
            ...
            <div class="px-8 py-4 bg-gray-50 text-center border-t border-gray-200">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="/register" class="font-medium text-zuppie-pink-600 hover:text-zuppie-pink-500">Sign up</a>
                </p>
            </div>
            <div class="mt-4 text-center">
                <a href="{{ route('phone.otp.login') }}" class="text-sm text-zuppie-600 hover:underline">
