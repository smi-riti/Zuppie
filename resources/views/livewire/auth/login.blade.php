    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <a href="/" class="flex items-center justify-center space-x-2 group">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-pink-600 group-hover:text-pink-700 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span class="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-purple-600 group-hover:from-pink-700 group-hover:to-purple-700 transition">
                    Zuppie
                </span>
            </a>
                ...
                <form wire:submit.prevent="login" class="space-y-6">
                    ...
                    <div>
                        <button type="submit" 
                            ...
                            Sign in
                            <svg wire:loading wire:target="login" xmlns="http://www.w3.org/2000/svg" class="animate-spin ml-2 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
