                ...
                @else
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <a href="{{ route('phone.otp.verify', ['phone_no' => $phone_no]) }}"
                            class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-white font-medium bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition transform hover:-translate-y-0.5 text-center">
                            Verify OTP
                        </a>
                    </div>
                @endif
