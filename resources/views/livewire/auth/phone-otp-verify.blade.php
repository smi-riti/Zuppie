        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input wire:model="otp" id="otp" name="otp" type="text" maxlength="6" required autofocus
                                class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-zuppie-pink-500 focus:border-zuppie-pink-500 placeholder-gray-400 text-center tracking-widest"
                                placeholder="XXXXXX">
                            @error('otp')
            ...
            <div class="px-8 py-4 bg-gray-50 text-center border-t border-gray-200">
                <p class="text-sm text-gray-600">
                    ...
                    <button wire:click="resendOtp" class="font-medium text-zuppie-pink-600 hover:text-zuppie-pink-500">Resend</button>
                </p>
            </div>
        </div>
    </div>
