    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
      ...
      <div class="p-8">
        ...
        <form wire:submit.prevent="submit" class="space-y-6">
          ...
          <div class="space-y-6">
            <h3 class="text-xl font-semibold text-purple-800 border-b-2 border-purple-100 pb-2">Your Information</h3>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                @error('name') <span class="text-sm text-pink-600">{{ $message }}</span> @enderror
              </div>
              ...
              <div>
                ...
                <input type="email" wire:model="email" 
                       class="w-full px-4 py-2 rounded-lg border border-purple-200 focus:ring-2 focus:ring-purple-300 focus:border-purple-400 transition">
                @error('email') <span class="text-sm text-pink-600">{{ $message }}</span> @enderror
              </div>
              ...
              <div>
                ...
                <input type="text" wire:model="phone_no" 
                       class="w-full px-4 py-2 rounded-lg border border-purple-200 focus:ring-2 focus:ring-purple-300 focus:border-purple-400 transition">
                @error('phone_no') <span class="text-sm text-pink-600">{{ $message }}</span> @enderror
              </div>
            </div>
          </div>
          ...
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                @error('event_package_id') <span class="text-sm text-pink-600">{{ $message }}</span> @enderror
              </div>
              ...
              <div>
                ...
                <input type="datetime-local" wire:model="booking_date" 
                       class="w-full px-4 py-2 rounded-lg border border-purple-200 focus:ring-2 focus:ring-purple-300 focus:border-purple-400 transition">
                @error('booking_date') <span class="text-sm text-pink-600">{{ $message }}</span> @enderror
              </div>
              ...
              <div>
                ...
                <input type="datetime-local" wire:model="event_date" 
                       class="w-full px-4 py-2 rounded-lg border border-purple-200 focus:ring-2 focus:ring-purple-300 focus:border-purple-400 transition">
                @error('event_date') <span class="text-sm text-pink-600">{{ $message }}</span> @enderror
              </div>
              ...
              <div>
                ...
                <input type="number" wire:model="guest_count" min="1" 
                       class="w-full px-4 py-2 rounded-lg border border-purple-200 focus:ring-2 focus:ring-purple-300 focus:border-purple-400 transition">
                @error('guest_count') <span class="text-sm text-pink-600">{{ $message }}</span> @enderror
              </div>
              ...
              <div class="md:col-span-2">
                ...
                <input type="text" wire:model="location" 
                       class="w-full px-4 py-2 rounded-lg border border-purple-200 focus:ring-2 focus:ring-purple-300 focus:border-purple-400 transition">
                @error('location') <span class="text-sm text-pink-600">{{ $message }}</span> @enderror
              </div>
              ...
              <div>
                ...
                <div class="px-4 py-2 bg-purple-50 rounded-lg border border-purple-200 text-purple-800 font-medium">
