    ...
    <nav class="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-200/50 z-50 lg:hidden shadow-2xl bottom-nav-tablet">
        <div class="flex items-center justify-around py-3 px-4 max-w-lg mx-auto">
            ...
            <a href="{{ route('home') }}" class="flex flex-col items-center space-y-1 p-3 rounded-xl transition-all duration-300 hover:bg-purple-50 group active:scale-95">
                <div class="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-purple-400 to-pink-400 text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
