...
>
    ...
    <div class="absolute inset-0 pointer-events-none">
        <div class="w-8 h-10 bg-gradient-to-b from-pink-400 to-pink-600 rounded-full opacity-60 animate-bounce absolute top-[15%] left-[8%]"></div>
        <div class="w-6 h-8 bg-gradient-to-b from-purple-400 to-purple-600 rounded-full opacity-60 animate-bounce absolute bottom-[20%] right-[12%] delay-200"></div>
        <div class="w-8 h-12 bg-gradient-to-b from-fuchsia-400 to-fuchsia-600 rounded-full opacity-60 animate-bounce absolute top-[30%] right-[10%] delay-500"></div>
    </div>
    ...
    <div class="relative z-10 text-center px-4 sm:px-6 w-full max-w-4xl mx-auto">
        <!-- Typewriter Heading -->
        <h1 
            class="text-3xl sm:text-5xl md:text-5xl lg:text-6xl font-medium text-white leading-tight mb-6"
        >
        ...
        <!-- Subtitle -->
        <p 
            x-text="subtitles[currentIndex]"
            class="text-lg sm:text-xl md:text-2xl text-purple-100 italic mb-8"
        ></p>

        <!-- CTA Buttons -->
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
                href="{{ route('event-packages') }}" wire:navigate
