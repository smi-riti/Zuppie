    ...
    <div class="container mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
            <a href="/" class="flex items-center space-x-2 group">
                <div class="">
                    <img src="/images/logo.jpeg" alt="Zuppie Logo" class="h-10 w-12">
                </div>
                <span
                    ...
                    <div x-show="showMegaMenu" x-transition
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <ul class="space-y-2">
                                    <li><a href="#"
                                            class="flex items-center text-pink-700 hover:text-pink-600 transition">
                                    ...
                                    <li><a href="#"
                                            class="flex items-center text-pink-700 hover:text-pink-600 transition">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-pink-400"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                ...
                                <ul class="space-y-2">
                                    <li><a href="#"
                                            class="text-pink-700 hover:text-pink-600 transition">Venues</a></li>
                                    <li><a href="#"
                                            class="text-pink-700 hover:text-pink-600 transition">Catering</a></li>
                                    <li><a href="#"
                                            class="text-pink-700 hover:text-pink-600 transition">Photographers</a></li>
                                    <li><a href="#" class="text-pink-700 hove <a href="/"
                                            class="flex items-center space-x-2 group">
                                            <div
                                                class="animate__animated animate__pulse animate__infinite animate__slower">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="h-10 w-10 text-purple-600 group-hover:text-pink-600 transition"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        </a>r:text-pink-600 transition">Decorators</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
