    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
                ...
                <p class="text-zuppie-pink-100 mb-6">{{ $settings['site_description'] }}</p>
                <div class="flex space-x-4">
                    @if($settings['twitter_link'])
                    <a href="{{ $settings['twitter_link'] }}" target="_blank" class="text-zuppie-pink-200 hover:text-white transition transform hover:-translate-y-1">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
                    </a>
                    @endif
                    @if($settings['instagram_link'])
                    <a href="{{ $settings['instagram_link'] }}" target="_blank" class="text-zuppie-pink-200 hover:text-white transition transform hover:-translate-y-1">
                    ...
                    <a href="{{ $settings['linkedin_link'] }}" target="_blank" class="text-zuppie-pink-200 hover:text-white transition transform hover:-translate-y-1">
            ...
            <div>
                ...
                <ul class="space-y-3 text-zuppie-pink-100">
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-zuppie-pink-300 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-zuppie-pink-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Copyright -->
        <div class="border-t border-zuppie-pink-700 pt-8 text-center">
            <p class="text-zuppie-pink-200">&copy; {{ date('Y') }} {{ $settings['site_name'] }}. All rights reserved.</p>
            <div class="mt-2 flex justify-center space-x-6">
                <a href="{{ route('privacy-policy') }}" class="text-zuppie-pink-200 hover:text-white transition text-sm">Privacy Policy</a>
                <a href="{{ route('terms-of-service') }}" class="text-zuppie-pink-200 hover:text-white transition text-sm">Terms of Service</a>
                <a href="#" class="text-zuppie-pink-200 hover:text-white transition text-sm">Sitemap</a>
            </div>
        </div>
    </div>
</footer>