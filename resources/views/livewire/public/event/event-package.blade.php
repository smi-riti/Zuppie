<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50">
                    ...
                    @foreach($this->allCategories as $category)
                        <div wire:click="openCategoryModal('{{ $category->slug }}')" 
                            ...
                            <div class="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 bg-gradient-to-br from-purple-100 to-pink-100 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                <i class="{{ $this->getCategoryIcon($category->slug) }} text-lg sm:text-2xl text-purple-600 group-hover:text-pink-600"></i>
                            </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative">
                <div id="popular-carousel" class="flex overflow-x-auto space-x-6 scrollbar-hide scroll-smooth" style="scrollbar-width: none; -ms-overflow-style: none;">
    ...
    @foreach($specialCategories as $category)
        <section class="py-16 {{ $loop->even ? 'bg-white' : 'bg-gray-50' }}">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative">
                    <div id="category-{{ $category['slug'] }}-carousel" class="flex overflow-x-auto space-x-6 scrollbar-hide scroll-smooth category-carousel" style="scrollbar-width: none; -ms-overflow-style: none;">
