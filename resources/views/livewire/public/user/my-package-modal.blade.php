            ...
            <div class="bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all" wire:click.stop>
                ...
                <div class="p-6 md:p-8 space-y-6 max-h-[80vh] overflow-y-auto bg-gray-50 rounded-lg shadow-sm">
                    ...
                    <div class="pb-4 border-b border-gray-200">
                        <h2 class="text-2xl font-bold text-purple-800">Booking Summary</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="p-5 bg-white rounded-lg shadow">
                                <h4
                                    class="text-lg font-semibold text-purple-700 pb-2 border-b border-gray-200 flex items-center">
                                ...
                                <div class="mt-4 space-y-3">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 py-2">
                                        ...
                                        <span
                                            class="text-xl font-semibold text-purple-700">₹{{ number_format($booking->total_price, 2) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-5 bg-white rounded-lg shadow">
                                ...
                                <div class="mt-4 space-y-3">
                                    <div class="flex items-center py-3 border-b border-gray-100">
                                        <div
                                            class="w-12 h-12 rounded-full bg-purple-100 flex items-center justify-center text-purple-700 font-bold">
