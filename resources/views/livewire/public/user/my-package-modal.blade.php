            ...
            <div class="bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all" wire:click.stop>
                ...
                <div class="p-6 md:p-8 space-y-6 max-h-[80vh] overflow-y-auto bg-gray-50 rounded-lg shadow-sm">
                    ...
                    <div class="pb-4 border-b border-gray-200">
                        <h2 class="text-2xl font-bold text-zuppie-800">Booking Summary</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="p-5 bg-white rounded-lg shadow">
                                <h4
                                    class="text-lg font-semibold text-zuppie-700 pb-2 border-b border-gray-200 flex items-center">
                                ...
                                <div class="mt-4 space-y-3">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 py-2">
                                        ...
                                        <span
                                            class="text-xl font-semibold text-zuppie-700">₹{{ number_format($booking->total_price, 2) }}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="p-5 bg-white rounded-lg shadow">
                                ...
                                <div class="mt-4 space-y-3">
                                    <div class="flex items-center py-3 border-b border-gray-100">
                                        <div
                                            class="w-12 h-12 rounded-full bg-zuppie-100 flex items-center justify-center text-zuppie-700 font-bold">
                                            {{ substr($booking->booking_name, 0, 1) }}
                                        </div>
                                        <div class="ml-4">
                                            <h5 class="font-semibold text-gray-800">{{ $booking->booking_name }}</h5>
                                ...
                                <div class="mt-4 space-y-4">
                                    <div class="flex">
                                        <div class="flex flex-col items-center mr-4">
                                            <div class="w-3 h-3 rounded-full bg-zuppie-500 mt-1"></div>
                            ...
                            <!-- Actions Card -->
                            <div class="p-5 bg-white rounded-lg shadow">
                                <h4 class="text-lg font-semibold text-zuppie-700 pb-2 border-b border-gray-200">Actions
                                </h4>
                ...
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
                    <button wire:click="closeViewModal"
                        class="px-4 py-2 text-gray-700 hover:text-zuppie-600 font-medium rounded-lg transition-colors">
                        Close
                    </button>
                </div>
            </div>
