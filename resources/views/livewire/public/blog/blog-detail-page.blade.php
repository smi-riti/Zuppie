<div class="min-h-screen bg-gray-50">
    ...
    <div class="px-4 sm:px-6 lg:px-20 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <article class="w-full lg:w-2/3">
            <header class="mb-10">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    ...
                    <div class="flex items-center space-x-1">
                        ...
                        <a href="https://twitter.com/intent/tweet?text={{ urlencode($blog->title) }}&url={{ urlencode(request()->url()) }}" target="_blank" class="p-2 rounded-full bg-gray-100 text-gray-600 hover:bg-indigo-100 hover:text-indigo-600 transition-colors">
                            <!-- Twitter SVG -->
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
                        </a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}" target="_blank" class="p-2 rounded-full bg-gray-100 text-gray-600 hover:bg-indigo-100 hover:text-indigo-600 transition-colors">
                            <!-- Facebook SVG -->
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                    </div>
                </div>
                <h1 class="text-3xl md:text-4xl font-2xl text-gray-900 leading-tight mb-6">
                    {{ $blog->title }}
                </h1>
                <div class="flex items-center space-x-3">
            ...
            <div class="mb-10 rounded-xl overflow-hidden">
                <img src="{{ $blog->featuredImage->image_url }}" alt="{{ $blog->title }}" class="w-full h-auto object-cover rounded-xl">
            </div>
            @endif
            ...
            <div class="mb-12">
                <h3 class="text-xl font-2xl text-gray-900 mb-4">Gallery</h3>
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    ...
                    <div class="group cursor-pointer" onclick="openImageModal('{{ $galleryImage->image_url }}')">
                        <img src="{{ $galleryImage->image_url }}" alt="Gallery Image" class="w-full h-40 object-cover rounded-lg group-hover:opacity-90 transition-opacity">
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            <footer class="border-t border-gray-200 pt-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <a href="/blog" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-medium transition-colors">
        ...
        <aside class="w-full lg:w-1/3">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6 mb-8">
                <h3 class="text-lg font-2xl text-gray-900 mb-4">About the Author</h3>
            ...
            <!-- Table of Contents -->
            <div class="bg-white rounded-xl border border-gray-200 p-6 mb-8">
                <h3 class="text-lg font-2xl text-gray-900 mb-4">Table of Contents</h3>
            ...
            <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-xl p-6 text-white">
                <h3 class="text-lg font-2xl mb-2">Join the Newsletter</h3>
    ...
    <section class="bg-white border-t border-gray-200">
        <div class="sm:px-6 lg:px-20 py-12">
            <h2 class="text-2xl font-2xl text-gray-900 mb-8">You Might Also Like</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($relatedBlogs as $relatedBlog)
                <article class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    @if($relatedBlog->featuredImage)
                    <div class="aspect-w-16 aspect-h-10">
                        <img src="{{ $relatedBlog->featuredImage->image_url }}" alt="{{ $relatedBlog->title }}" class="w-full h-48 object-cover">
                    </div>
                    @else
                    ...
                    <div class="p-5">
                        ...
                        @endif
                        <h3 class="text-lg font-2xl text-gray-900 mb-2 line-clamp-2">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            ...
                            <a href="/blog/{{ $relatedBlog->slug }}" class="text-indigo-600 hover:text-indigo-800 font-medium text-sm flex items-center">
                                Read
